<div class="crm-form crm-form-block crm-string_override-form-block">
  <div class="crm-submit-buttons">{include file="CRM/common/formButtons.tpl" location="top"}</div>
    <table class="form-layout-compressed">
      <tr class="crm-admin-options-form-block-kimai-projects">
        <td class="label">{$form.kimai_projects.label}</td>
        <td>{$form.kimai_projects.html}</td>
      </tr>
      <tr class="crm-admin-options-form-block-civicrm-organization">
        <td class="label">{$form.civicrm_organization.label}</td>
        <td>{$form.civicrm_organization.html}</td>
      </tr>
    </table>
