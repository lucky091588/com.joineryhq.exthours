 ...
 */
class CRM_Exthours_Form_Settings extends CRM_Core_Form {

  public static $settingFilter = array('group' => 'exthours');
  public static $extensionName = 'com.joineryhq.exthours';
  ...
  public function preProcess() {
    CRM_Utils_System::setTitle(E::ts('External Hours: Kimai Settings'));
  }
  ...
  public function buildQuickForm() {
    ...
    $this->assign("exthoursKimaiUrl", Civi::settings()->get('exthours_kimai_url'));
    $this->assign("exthoursKimaiAPIKey", Civi::settings()->get('exthours_kimai_api_key'));
    ...
    $session->pushUserContext(CRM_Utils_System::url('civicrm/admin/exthours/settings', 'reset=1', TRUE));
  ...
  public function postProcess() {
    ...
    // If exthours_kimai_url is empty or updated, remove current api key
    if (
      !$this->_submittedValues['exthours_kimai_url']
      || $this->_submittedValues['exthours_kimai_url'] !== Civi::settings()->get('exthours_kimai_url')
    ) {
      unset($this->_submittedValues['exthours_kimai_api_key']);
    }
  ...
  public static function getSettings() {
    $settings = _exthours_civicrmapi('setting', 'getfields', array('filters' => self::$settingFilter));
  ...
  public function saveSettings() {
    ...
    _exthours_civicrmapi('setting', 'create', $values);
    ...
    _exthours_civicrmapi('setting', 'create', $unsettings);
  ...
  public function setDefaultValues() {
    $result = _exthours_civicrmapi('setting', 'get', array('return' => array_keys($this->_settings)));
